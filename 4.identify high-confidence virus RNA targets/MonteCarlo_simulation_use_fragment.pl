...
foreach my $sam (@reps_inter_chimeric_sam){
	$reps++;
	print "perl $dirs/scripts/0.prepare/from_sam_to_pair_reads_bed_use_fragment.pl $sam\n";
	...
	print "perl $dirs/scripts/0.prepare/count_RRI_multiple_details_addMultiple_use_fragment.pl gene_overlap_with_read1.bed gene_overlap_with_read2.bed > rep$reps.interGene.network\n";
}
